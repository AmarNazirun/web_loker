                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $query = "INSERT INTO prestasi_calon (lembaga, bidang, tahun_awal, tahun_akhir, negara_kota, id_calon) VALUES ('$lembaga', '$bidang', '$tahun_awal', '$tahun_akhir', '$negara_kota', $data[id_calon])";
