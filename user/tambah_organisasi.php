        ...
        <section class="section dashboard">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Tambah Pengalaman Organisasi</h5>
                            ...
                            <form action="" method="post" class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="negara_kota" name="negara_kota" required>
                                </div>
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $query = "INSERT INTO organisasi_calon (lembaga, bidang, tahun_awal, tahun_akhir, negara_kota, id_calon) VALUES ('$lembaga', '$bidang', '$tahun_awal', '$tahun_akhir', '$negara_kota', $data[id_calon])";
