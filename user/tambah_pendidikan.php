                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post" class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" id="lulus" name="lulus" required>
                                </div>
                                <div class="col-md-4">
                            ...
                            if (isset($_POST['submit'])) {
                                ...
                                $query = "INSERT INTO pendidikan_calon (lembaga, jurusan, tahun_awal, tahun_akhir, kota, lulus, gpa, id_calon) VALUES ('$lembaga', '$jurusan', '$tahun_awal', '$tahun_akhir', '$kota', '$lulus', '$gpa', $data[id_calon])";
