...
if (isset($_POST['simpan_perubahan'])) {
    ...
    $query_update_profile = "UPDATE data_perusahaan SET nama_perusahaan='$nama_perusahaan', telepon='$telepon', alamat='$alamat', email='$email', username='$username' WHERE id_perusahaan=$id_perusahaan";
